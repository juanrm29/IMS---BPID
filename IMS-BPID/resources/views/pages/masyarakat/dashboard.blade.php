                ...
                <div class="dashboard-header">
                    <div class="dashboard-header-content">
                        ...
                        <div class="welcome-title">
                            <h1>Welcome Back, <span> {{auth()->user()->name}} !</span>
                                <span class="winner-icon">
                                    <img src="{{ asset ('backend/img/trophy.svg')}}" alt="trophy">
                                </span>
                            </h1>
                        </div>
                        ...
                        <div class="sales-tile-container">
                            <div class="sales-tile">
                                <h1>{{ \Carbon\Carbon::now()->format('H') }}</h1>

                            </div>
                            <div class="sales-tiles">
                                <h1>:</h1>

                            </div>
                            <div class="sales-tile">
                                <h1>{{ \Carbon\Carbon::now()->format('i') }}</h1>
            ...
            <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="consulting-card">
                    ...
                    <div class="consulting-card-body">
                        <h4>Tulis Ide Anda</h4>
                        <p>Kirim ide-ide dan solusi anda sekarang</p>
                        <a href="{{ url('user/add')}} " class="btn btn-info stripes-btn">Action</a>
                    </div>
                </div>
            </div>
